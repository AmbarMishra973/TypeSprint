      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <CalendarDays size={32} color="var(--accent-color)" /> Daily
              Challenge
            </h1>
            ...
            >
              <Clock size={16} color="var(--accent-color)" /> Resets in:{" "}
                ...
                return (
                  ...
                  >
                    ...
                    {word.split("").map((char, cIdx) => {
                      ...
                      const isCaret =
                        isCurrentWord && cIdx === typed.length;
          ...
          {submitted && (
            ...
            >
              <CheckCircle2 size={20} /> Score successfully recorded for
              today!
            </div>
          )}
        </div>
        ...
        >
          ...
          {leaderboard.length === 0 ? (
            ...
            >
              ...
              />
              <br />
              No scores submitted yet today. <br /> Set the benchmark!
            </div>
          ) : (
            <ul
              style={{
