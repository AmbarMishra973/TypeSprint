...
public class UserController {
    ...
    public ResponseEntity<?> syncStats(@RequestBody User request) {
        User updatedUser = userService.syncStats(
                request.getName(),
                request.getPassword(),
                request.getTypingStats()
        );
    ...
    public ResponseEntity<?> sendRequest(
        ...
        return ResponseEntity.ok(
                userService.sendFriendRequest(username, receiverName)
        );
    }
    ...
    public ResponseEntity<?> acceptRequest(
        ...
        return ResponseEntity.ok(
                userService.acceptFriendRequest(username, requesterName)
        );
    }
    ...
    public ResponseEntity<?> rejectRequest(
        ...
        return ResponseEntity.ok(
                userService.rejectFriendRequest(username, requesterName)
        );
    }
    ...
    public ResponseEntity<?> updateUserXp(@RequestBody Map<String, Object> request) {
        ...
        // Update this line to search by name/username
